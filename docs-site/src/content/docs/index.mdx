---
title: Automata Documentation
description: Build and run Finite State Machines in Java with ease.
template: splash # Remove or comment out this line to display the site sidebar on this page.
hero:
  tagline: A simple and flexible Finite State Machine library for Java.
  image:
    file: ../../assets/houston.webp
  actions:
    - text: Get Started
      link: /guides/turnstile-example/
      icon: right-arrow
