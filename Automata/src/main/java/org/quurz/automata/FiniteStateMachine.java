...
import static org.quurz.automata.localisation.AutomataMessages.emptyInputAlphabet;
import static org.quurz.automata.localisation.AutomataMessages.emptyOutputAlphabet;
import static org.quurz.automata.localisation.AutomataMessages.emptyStateSet;
import static org.quurz.automata.localisation.AutomataMessages.endStatesNotATrueSubsetOfStates;
import static org.quurz.automata.localisation.AutomataMessages.nullElementsInInputAlphabet;
import static org.quurz.automata.localisation.AutomataMessages.nullElementsInOutputAlphabet;
import static org.quurz.automata.localisation.AutomataMessages.nullElementsInStateSet;
import static org.quurz.automata.localisation.AutomataMessages.unknownInputToken;
import static org.quurz.automata.localisation.AutomataMessages.unknownOutputToken;
import static org.quurz.automata.localisation.AutomataMessages.unknownStartState;
...
import static org.quurz.foomp.base.util.Util.requireNonEmpty;
import static org.quurz.foomp.base.util.Util.requireNonNullElementsInCollection;
import static org.quurz.foomp.base.util.Util.requireSubSet;
...
public class FiniteStateMachine<S, IA, OA>
    ...
    private final Set<StateTransitionEventListener<S>> listeners;
    ...
    private FiniteStateMachine(final @NonNull Set<S> states,
        ...
        this.inputAlphabet
            = new HashSet<>(
                requireNonEmpty(
                    ...
                    () -> new IllegalArgumentException(emptyInputAlphabet())
                )
            );
        ...
        if (!this.states.contains(this.currentState)) {
            throw new IllegalArgumentException(unknownStartState(this.currentState));
        }
     ...
     * <div>
     *     <p>
     *         Returns a copy of the set of all valid states of this state machine.
     *     </p>
     * </div>
     *
     * @return a defensive copy of the set of states
     *
     * @since 1.0.0
     */
     ...
     * <div>
     *     <p>
     *         Returns a copy of the input alphabet of this state machine.
     *     </p>
     * </div>
     *
     * @return a defensive copy of the set of valid input symbols
     *
     * @since 1.0.0
     */
    public @NonNull Set<IA> getInputAlphabet() {
        return new HashSet<>(this.inputAlphabet);
    }

    /**
     * <div>
     *     <p>
     *         Returns a copy of the output alphabet of this state machine.
     *     </p>
     * </div>
     *
     * @return a defensive copy of the set of valid output symbols
     *
     * @since 1.0.0
     */
    public @NonNull Set<OA> getOutputAlphabet() {
        return new HashSet<>(this.outputAlphabet);
    }

    /**
     * <div>
     *     <p>
     *         Returns a copy of the set of accepting end states of this state machine.
     *     </p>
     * </div>
     *
     * @return a defensive copy of the set of end states
     *
     * @since 1.0.0
     */
    public @NonNull Set<S> getEndStates() {
        return new HashSet<>(this.endStates);
    }
     ...
     * </div>
     *
     * @return the initial state configured for this machine
     *
     * @since 1.0.0
     */
     ...
     * <div>
     *     <p>
     *         Registers a listener for receiving state transition events.
     *     </p>
     *     <p>
     *         This method is thread-safe. If the given listener is already registered,
     ...
     * <div>
     *     <p>
     *         Unregisters a previously registered state transition listener.
     *     </p>
     *     <p>
     *         This method is thread-safe. If the given listener is not currently registered,
     *         calling this method has no effect.
     *     </p>
     * </div>
     *
        ...
        if (this.inputAlphabet.contains(input)) {
            ...
            try {
                ...
                if (this.states.contains(newState)) {
                    ...
                    this.fireStateTransitionEvent(currentState, newState);
                    this.currentState
                        = newState;
    ...
    private void fireStateTransitionEvent(final S oldState,
                                          final S newState) {
        final var stateTransitionEvent
            =  new StateTransitionEvent<>(oldState, newState);
        this.listeners.forEach(listener -> listener.stateTransition(stateTransitionEvent));
    }
